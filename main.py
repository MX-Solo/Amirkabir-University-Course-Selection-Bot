...
while True:
    if CheckSiteIsOpen():
        ...
        def send_request(st_reg_courseid, st_reg_groupno):
            ...
            # td_elements = soup.find_all('td', class_='frmtrc')
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            futures = [executor.submit(send_request, st_reg_courseid, st_reg_groupno) for st_reg_courseid, st_reg_groupno in lines]
